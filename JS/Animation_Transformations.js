...
const transformation_load = new CustomEvent("transformation_load");

let client = new XMLHttpRequest();
client.open('GET', '/Images/Cours/Lobster.svg');
...
client2.open('GET', '/Images/Cours/Lobster2.svg');
...
window.addEventListener("page_content_loaded", () => { Init() })


function Init()
{
	if (lobster1img == "" && lobster2img == "") return;

	window.dispatchEvent(transformation_load);
}
