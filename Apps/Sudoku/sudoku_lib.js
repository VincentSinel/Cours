...
(function(root){
    ...
    // Solve
    // -------------------------------------------------------------------------
    sudoku.solve = function(board, reverse, unique_test = false){
        ...
        */
        ...
        var result = sudoku._search(candidates, reverse, unique_test);
    ...
    sudoku._search = function(candidates, reverse, unique_test){
        ...
        */
        ...
        if(max_nr_candidates === 1){
            if (unique_test){
                ...
                // Stop if more than 1 solution is found
